...
# make a certificate
wget -O /etc/stunnel/stunnel.pem "https://raw.githubusercontent.com/GanzKurosaki/install/master/stunnel.pem.crt"
...
#wget -O /etc/iptables.up.rules "https://raw.githubusercontent.com/GanzKurosaki/centos6/master/iptables.up.rules"
...
#wget -O /etc/security/limits.conf "https://raw.githubusercontent.com/GanzKurosaki/centos6/master/limits.conf"
...
wget -O /etc/issue.net "https://raw.githubusercontent.com/GanzKurosaki/install/master/issue.net"
